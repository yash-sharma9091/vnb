...
mimicTrading.controller('loginCtrl', ['$scope', '$state', '$http', 'RestSvr', 'loginSrv', function ($scope, $state, $http, RestSvr, loginSrv) {
...
mimicTrading.controller('userCtrl', ['$scope', '$state', '$rootScope', 'Upload', 'appSvr', function ($scope, $state, $rootScope, Upload, appSvr) {
   ...
   */
		if ($state.current.name === 'users') {
			...
			TableAjax.init({
				url: 'user/list',
				columns: [{ "data": "id", "orderable": false }, { "data": "sr_no" }, { "data": "contact_name" }, { "data": "contact_telephoneno" }, { "data": "school_name" }, { "data": "no_of_students" }, { "data": "school_type" }, { "data": "school_level" }, { "data": "status" }, { "data": "action", "orderable": false }]
			});
		}
	});
