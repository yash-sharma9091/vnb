...
mimicTrading.controller('cmsCtrl', ['$scope', '$state', 'RestSvr', '$rootScope', 'appSvr', function ($scope, $state, RestSvr, $rootScope, appSvr) {
   ...
   */
		...
		TableAjax.init({
			url: 'cms/list/',
			columns: [{ "data": "id", "orderable": false }, { "data": "title" },
			//{ "data": "description"},
			{ "data": "slug" }, { "data": "updated_date" }, { "data": "status" }, { "data": "action", "orderable": false }]
		});
	});
}]);
'use strict';
...
mimicTrading.controller('cmsViewCtrl', ['$scope', '$state', 'RestSvr', '$rootScope', 'appSvr', 'cms', function ($scope, $state, RestSvr, $rootScope, appSvr, cms) {
   ...
   */
	...
	$scope.goToEdit = function () {
		return $state.go('editcms', { slug: $state.params.slug });
	};
}]);
'use strict';
...
mimicTrading.controller('faqCtrl', ['$scope', '$state', 'RestSvr', '$rootScope', 'appSvr', function ($scope, $state, RestSvr, $rootScope, appSvr) {
   ...
   */
		...
		TableAjax.init({
			url: 'faq/list/',
			columns: [{ "data": "id", "orderable": false }, { "data": "question" }, { "data": "order" }, { "data": "status" }, { "data": "updated_date" }, { "data": "action", "orderable": false }]
		});
	});
}]);
'use strict';
...
mimicTrading.controller('homepageEditCtrl', ['$scope', '$state', 'RestSvr', '$rootScope', 'appSvr', 'Upload', 'homepage', function ($scope, $state, RestSvr, $rootScope, appSvr, Upload, homepage) {
	$scope.$on('$viewContentLoaded', function () {
		/**
   * Initialize the jquery components when view contents loaded properly
   */
	...
	$scope.update_homepage = function (isValid, data) {
		if (!isValid) {
			App.scrollTop();
			return;
		}
		$scope.isLoading = true;
		var req = '';
		var urlId = angular.copy(data.video_url, req);
		data.video_url_id = YouTubeGetID(urlId);
		Upload.upload({
			url: baseUrl('homepage/edit'),
			data: data
		}).then(function (response) {
			return Upload.resize(data.banner_img, { width: 60, height: 60 }).then(function (resizedFile) {
				return resizedFile;
			});
		}).then(function (response) {
...
mimicTrading.controller('homepageViewCtrl', ['$scope', '$state', 'RestSvr', '$rootScope', 'appSvr', 'homepage', '$uibModal', 'homepageSvr', function ($scope, $state, RestSvr, $rootScope, appSvr, homepage, $uibModal, homepageSvr) {
...
mimicTrading.controller('loginCtrl', ['$scope', '$rootScope', '$state', '$http', 'RestSvr', 'loginSrv', function ($scope, $rootScope, $state, $http, RestSvr, loginSrv) {
  ...
  */
    ...
    */
	...
	$scope.forgotpassword = function () {
		$scope.isLoading = true;
		var inputjson = { email: $scope.email };
		$http.post('adminapi/forgotpassword', inputjson).then(function (response) {
...
mimicTrading.controller('myaccountCtrl', ['$scope', '$state', 'RestSvr', '$rootScope', 'appSvr', function ($scope, $state, RestSvr, $rootScope, appSvr) {
...
mimicTrading.controller('privacypolicyCreateCtrl', ['$scope', '$state', 'RestSvr', '$rootScope', 'appSvr', 'privacypolicySvr', function ($scope, $state, RestSvr, $rootScope, appSvr, privacypolicySvr) {
   ...
   */
	...
	$scope.new_privacypolicy = function (isValid) {
		if (!isValid) {
			return;
		}

		$scope.isLoading = true;
		RestSvr.post('privacypolicy/add', $scope.privacypolicy).then(function (response) {
...
mimicTrading.controller('privacypolicyCtrl', ['$scope', '$state', 'RestSvr', '$rootScope', 'appSvr', function ($scope, $state, RestSvr, $rootScope, appSvr) {
   ...
   */
		...
		TableAjax.init({
			...
			columns: [{ "data": "id", "orderable": false }, { "data": "title" }, { "data": "description" }, { "data": "status" }, { "data": "created_date" }, { "data": "action", "orderable": false }]
		});
	});
}]);
'use strict';

mimicTrading.controller('privacypolicyEditCtrl', ['$scope', '$state', 'RestSvr', '$rootScope', 'appSvr', 'privacypolicy', function ($scope, $state, RestSvr, $rootScope, appSvr, privacypolicy) {
   ...
   */
	...
	$scope.edit_privacypolicy = function (isValid) {
		if (!isValid) {
			return;
		}

		$scope.isLoading = true;
		RestSvr.put('privacypolicy/edit', $scope.privacypolicy).then(function (response) {
			$state.go('privacypolicy');
		}).catch(function (errors) {
			App.alert({ type: 'danger', icon: 'warning', message: errors.message, container: $rootScope.settings.errorContainer, place: 'prepend' });
		}).then(function () {
...
mimicTrading.controller('privacypolicyViewCtrl', ['$scope', '$state', 'RestSvr', '$rootScope', 'appSvr', 'privacypolicy', function ($scope, $state, RestSvr, $rootScope, appSvr, privacypolicy) {
   ...
   */
	...
	$scope.privacypolicy = privacypolicy.record;
	$scope.goToEdit = function () {
		return $state.go('editprivacypolicy', { id: $state.params.id });
	};
}]);
'use strict';

mimicTrading.controller('resetPasswordCtrl', ['$scope', '$state', '$rootScope', '$http', function ($scope, $state, $rootScope, $http) {

  $scope.resetpassword = function (valid, formdata) {

    if (formdata.new_password == formdata.confirm_password) {
      var pwdregex = /^[a-z0-9].{6,255}$/,
          inputJson = {};
      ...
      if (pwdregex.test(formdata.new_password)) {
        ...
        var msg = "Password must be alpha-numeric and minimum 6 characters.";
        App.alert({ type: 'danger', icon: 'danger', message: msg, container: $rootScope.settings.errorContainer, place: 'prepend' });
        return;
      }
    } else {
      var _msg = "New Password and confirm password must be same.";
      App.alert({ type: 'danger', icon: 'danger', message: _msg, container: $rootScope.settings.errorContainer, place: 'prepend' });
      return;
    }
  };
}]);
...
mimicTrading.controller('sociallinkCreateCtrl', ['$scope', '$state', 'RestSvr', '$rootScope', 'appSvr', 'sociallinkSvr', function ($scope, $state, RestSvr, $rootScope, appSvr, sociallinkSvr) {
   ...
   */
	...
	$scope.new_sociallink = function (isValid) {
		if (!isValid) {
			return;
		}

		$scope.isLoading = true;
		RestSvr.post('sociallink/add', $scope.sociallink).then(function (response) {
			$state.go('sociallink');
		}).catch(function (errors) {
			App.alert({ type: 'danger', icon: 'warning', message: errors.message, container: $rootScope.settings.errorContainer, place: 'prepend' });
		}).then(function () {
...
mimicTrading.controller('sociallinkCtrl', ['$scope', '$state', 'RestSvr', '$rootScope', 'appSvr', function ($scope, $state, RestSvr, $rootScope, appSvr) {
   ...
   */
		...
		TableAjax.init({
			url: 'sociallink/list/',
			columns: [{ "data": "id", "orderable": false }, { "data": "title" }, { "data": "url" }, { "data": "status" }, { "data": "updated_date" }, { "data": "action", "orderable": false }]
		});
	});
}]);
'use strict';

mimicTrading.controller('sociallinkEditCtrl', ['$scope', '$state', 'RestSvr', '$rootScope', 'appSvr', 'sociallink', 'sociallinkSvr', function ($scope, $state, RestSvr, $rootScope, appSvr, sociallink, sociallinkSvr) {
   ...
   */
	...
	$scope.edit_sociallink = function (isValid) {
		if (!isValid) {
			return;
		}

		$scope.isLoading = true;
		RestSvr.put('sociallink/edit', $scope.sociallink).then(function (response) {
			$state.go('sociallink');
		}).catch(function (errors) {
			App.alert({ type: 'danger', icon: 'warning', message: errors.message, container: $rootScope.settings.errorContainer, place: 'prepend' });
		}).then(function () {
...
mimicTrading.controller('sociallinkViewCtrl', ['$scope', '$state', 'RestSvr', '$rootScope', 'appSvr', 'sociallink', function ($scope, $state, RestSvr, $rootScope, appSvr, sociallink) {
   ...
   */
	...
	$scope.sociallink = sociallink.record;
	$scope.goToEdit = function () {
		return $state.go('editsociallink', { _id: $state.params._id });
	};
}]);
'use strict';
...
mimicTrading.controller('userCtrl', ['$scope', '$state', '$rootScope', 'Upload', 'appSvr', function ($scope, $state, $rootScope, Upload, appSvr) {
   ...
   */
		if ($state.current.name === 'users') {
			...
			TableAjax.init({
				url: 'user/list',
				columns: [{ "data": "id", "orderable": false }, { "data": "sr_no", "orderable": false },
				//{ "data": "contact_name" },
				{ "data": "contact_telephoneno" }, { "data": "email_address" }, { "data": "school_name" }, { "data": "school_address" },
				//{ "data": "no_of_students" },
				{ "data": "pilot_request" }, { "data": "action", "orderable": false }]
			});
		}
	});
}]);
...
mimicTrading.controller('userViewCtrl', ['$scope', '$rootScope', '$state', 'user', 'appSvr', 'userSvr', function ($scope, $rootScope, $state, user, appSvr, userSvr) {
  $scope.$on('$viewContentLoaded', function () {
    /**
     * Initialize the jquery components when view contents loaded properly
     */
      ...
      if (userdata.pilot_request == "Approved") {
        ...
        bootbox.confirm({
          ...
          callback: function callback(result) {
            if (result === true) {
              userSvr.approveReject(inputJson).then(function (result) {
          ...
          buttons: {
            ...
            confirm: {
              ...
              callback: function callback() {
                var selectedReason = $(".target option:selected").text();
                var enteredReason = $("#reason").val();
...
mimicTrading.controller('whatdostepsCreateCtrl', ['$scope', '$state', 'RestSvr', '$rootScope', 'appSvr', 'whatdostepsSvr', function ($scope, $state, RestSvr, $rootScope, appSvr, whatdostepsSvr) {
   ...
   */
	...
	$scope.new_whatdosteps = function (isValid) {
		if (!isValid) {
			return;
		}

		$scope.isLoading = true;
		RestSvr.post('whatdosteps/add', $scope.whatdosteps).then(function (response) {
...
mimicTrading.controller('whatdostepsCtrl', ['$scope', '$state', 'RestSvr', '$rootScope', 'appSvr', function ($scope, $state, RestSvr, $rootScope, appSvr) {
   ...
   */
		...
		TableAjax.init({
			...
			columns: [{ "data": "id", "orderable": false }, { "data": "title" }, { "data": "short_description" },
			//{ "data": "long_description" },
			{ "data": "status" }, { "data": "updated_date" }, { "data": "action", "orderable": false }]
		});
	});
}]);
'use strict';

mimicTrading.controller('whatdostepsEditCtrl', ['$scope', '$state', 'RestSvr', '$rootScope', 'appSvr', 'whatdosteps', 'whatdostepsSvr', function ($scope, $state, RestSvr, $rootScope, appSvr, whatdosteps, whatdostepsSvr) {
   ...
   */
	...
	$scope.edit_whatdosteps = function (isValid) {
		if (!isValid) {
			return;
		}

		$scope.isLoading = true;
		RestSvr.put('whatdosteps/edit', $scope.whatdosteps).then(function (response) {
			$state.go('whatdosteps');
		}).catch(function (errors) {
			App.alert({ type: 'danger', icon: 'warning', message: errors.message, container: $rootScope.settings.errorContainer, place: 'prepend' });
		}).then(function () {
...
mimicTrading.controller('whatdostepsViewCtrl', ['$scope', '$state', 'RestSvr', '$rootScope', 'appSvr', 'whatdosteps', function ($scope, $state, RestSvr, $rootScope, appSvr, whatdosteps) {
   ...
   */
	...
	$scope.whatdosteps = whatdosteps.record;
	$scope.goToEdit = function () {
		return $state.go('editwhatdosteps', { slug: $state.params.slug });
	};
}]);
'use strict';
...
mimicTrading.config(['$stateProvider', function ($stateProvider) {
	...
	var cmsResolver = ['cmsSvr', '$stateParams', function (cmsSvr, $stateParams) {
		return cmsSvr.getCMSById($stateParams.slug);
	}];
...
mimicTrading.config(['$stateProvider', function ($stateProvider) {
	...
	var homepageResolver = ['homepageSvr', '$stateParams', function (homepageSvr, $stateParams) {
		return homepageSvr.getHomepageData();
	}];
...
mimicTrading.config(['$stateProvider', function ($stateProvider) {
	...
	var myaccountResolver = ['myaccountSvr', '$stateParams', function (myaccountSvr, $stateParams) {
		return myaccountSvr.getCMSById($stateParams.slug);
	}];
...
mimicTrading.config(['$stateProvider', function ($stateProvider) {
	...
	var privacypolicyResolver = ['privacypolicySvr', '$stateParams', function (privacypolicySvr, $stateParams) {
		return privacypolicySvr.getPrivacyPolicyById($stateParams.id);
	}];
...
mimicTrading.config(['$stateProvider', function ($stateProvider) {
	...
	var sociallinkResolver = ['sociallinkSvr', '$stateParams', function (sociallinkSvr, $stateParams) {
		return sociallinkSvr.getCMSById($stateParams._id);
	}];

	$stateProvider.state('sociallink', {
		url: '/sociallink',
...
mimicTrading.config(['$stateProvider', function ($stateProvider) {
	...
	var whatdostepsResolver = ['whatdostepsSvr', '$stateParams', function (whatdostepsSvr, $stateParams) {
		return whatdostepsSvr.getCMSById($stateParams.slug);
	}];

	$stateProvider.state('whatdosteps', {
		url: '/whatdosteps',
...
mimicTrading.factory('cmsSvr', ['RestSvr', function (RestSvr) {
    return {
        getCMSById: function getCMSById(slug) {
            return RestSvr.get('cms/view/' + slug);
        },
...
mimicTrading.factory('homepageSvr', ['RestSvr', function (RestSvr) {
    return {
        getHomepageData: function getHomepageData() {
            return RestSvr.get('homepage/view');
        }
    };
}]);
'use strict';
...
mimicTrading.factory('myaccountSvr', ['RestSvr', function (RestSvr) {
    return {
        getCMSById: function getCMSById(slug) {
            return RestSvr.get('cms/view/' + slug);
        }
...
mimicTrading.factory('privacypolicySvr', ['RestSvr', function (RestSvr) {
    return {
        getPrivacyPolicyById: function getPrivacyPolicyById(id) {
            return RestSvr.get('privacypolicy/view/' + id);
        },
        getTermsConditionsTypes: function getTermsConditionsTypes() {
            return ['about_us', 'privacy_policy', 'terms_conditions'];
        }
    };
}]);
...
mimicTrading.factory('sociallinkSvr', ['RestSvr', function (RestSvr) {
    return {
        getCMSById: function getCMSById(slug) {
            return RestSvr.get('sociallink/view/' + slug);
        },
        getCMSTypes: function getCMSTypes() {
            return ['about_us', 'privacy_policy', 'terms_conditions'];
        }
...
mimicTrading.factory('userSvr', ['RestSvr', function (RestSvr) {
    return {
        ...
        approveReject: function approveReject(data) {
            return RestSvr.post('approverejectsingle', data);
        }
    };
}]);
'use strict';

mimicTrading.factory('whatdostepsSvr', ['RestSvr', function (RestSvr) {
    return {
        getCMSById: function getCMSById(slug) {
            return RestSvr.get('whatdosteps/view/' + slug);
        },
        getCMSTypes: function getCMSTypes() {
            return ['about_us', 'privacy_policy', 'terms_conditions'];
        }
