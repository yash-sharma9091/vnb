...
mimicTrading.controller('cmsCtrl', ['$scope', '$state', 'RestSvr', '$rootScope', 'appSvr', function ($scope, $state, RestSvr, $rootScope, appSvr) {
   ...
   */
		...
		TableAjax.init({
			...
			// { "data": "status" },
			{ "data": "created_date" }, { "data": "action", "orderable": false }]
		});
	});
}]);
'use strict';
...
mimicTrading.controller('userCtrl', ['$scope', '$state', '$rootScope', 'Upload', 'appSvr', function ($scope, $state, $rootScope, Upload, appSvr) {
   ...
   */
		if ($state.current.name === 'users') {
			...
			TableAjax.init({
				url: 'user/list',
				columns: [{ "data": "id", "orderable": false }, { "data": "sr_no", "orderable": false }, { "data": "contact_name" }, { "data": "contact_telephoneno" }, { "data": "email_address" }, { "data": "school_name" }, { "data": "school_address" },
				//{ "data": "no_of_students" },
...
mimicTrading.controller('userViewCtrl', ['$scope', '$state', 'user', 'appSvr', 'userSvr', function ($scope, $state, user, appSvr, userSvr) {
  ...
  * 
  */
	$scope.approveSingleReq = function (userdata) {
		var inputJson = {};
	...
	$scope.rejectSingleReq = function (userdata) {
		var inputJson = {};
		inputJson._id = userdata._id;
...
mimicTrading.controller('whatdostepsCtrl', ['$scope', '$state', 'RestSvr', '$rootScope', 'appSvr', function ($scope, $state, RestSvr, $rootScope, appSvr) {
   ...
   */
		...
		TableAjax.init({
			...
			columns: [
			// { "data": "id", "orderable": false },
			{ "data": "title" }, { "data": "short_description" }, { "data": "long_description" }, { "data": "order" },
			// { "data": "status" },
			{ "data": "created_date" }, { "data": "action", "orderable": false }]
		});
	});
